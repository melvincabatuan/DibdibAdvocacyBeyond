...
public final class Spiral {
    ...
    public Spiral(int maxRadius){
        mNativeAddr = nativeCreateObject(maxRadius);
    }



    public void apply(Mat src, Mat dst, int counter) {
        apply(mNativeAddr, src.getNativeObjAddr(),
                dst.getNativeObjAddr(), counter);
    }
    ...
    private static native long nativeCreateObject(int maxRadius);
    private static native void nativeDestroyObject(long thiz);
    private static native void apply(long thiz, long srcAddr, long dstAddr, int counter);
